...
48 components (atoms, molecules, organisms), fully typed, themeable
(light/dark), 532 tests, 90%/85% (lines/branches) coverage gate.
...
covered by 532 tests. One `<SearchList>` replaces a `FlatList` + search input +
