...
49 components (atoms, molecules, organisms), fully typed, themeable
(light/dark), 548 tests, 90%/85% (lines/branches) coverage gate.
...
covered by 548 tests. One `<SearchList>` replaces a `FlatList` + search input +
